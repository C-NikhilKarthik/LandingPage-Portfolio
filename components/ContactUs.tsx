          ...
          <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
              ...
              <div className="mt-8 lg:w-1/2 lg:mx-6">
                <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-[rgb(29,29,29)] shadow-2xl rounded-xl lg:max-w-xl">
                  ...
                  <form className="mt-6">
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        className="block w-full px-5 py-3 mt-2 border rounded-md bg-gray-800/30 text-gray-300 border-gray-600  focus:ring-blue-300 focus:ring-opacity-40 focus:border-blue-300 focus:outline-none focus:ring"
                      />
                    </div>
                    ...
                    <div className="w-full mt-6">
                      ...
                      <textarea
                        className="block w-full h-32 px-5 py-3 mt-2  placeholder-gray-400  border  rounded-md md:h-48 bg-gray-800/30 text-gray-300 border-gray-600  focus:ring-blue-300 focus:ring-opacity-40 focus:border-blue-300 focus:outline-none focus:ring"
                        placeholder="Message"
                      ></textarea>
                    </div>
